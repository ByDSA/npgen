export declare type CreateRepoParams = {
    name: string;
    description?: string;
    private?: boolean;
};
export declare function createRepo(opts: CreateRepoParams): Promise<import("@octokit/types").OctokitResponse<{
    id: number;
    node_id: string;
    name: string;
    full_name: string;
...
export declare function fetchUser(username: string): Promise<import("@octokit/types").OctokitResponse<{
    login: string;
    id: number;
    node_id: string;
    avatar_url: string;
